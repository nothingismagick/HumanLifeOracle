...
// Simple flow which takes a filtered transaction (exposing only a command containing the ALIVE response data) and returns
// a digital signature over the transaction Merkle root.
@InitiatingFlow
class SignHumanLife(val oracle: Party, val ftx: FilteredTransaction) : FlowLogic<TransactionSignature>() {
